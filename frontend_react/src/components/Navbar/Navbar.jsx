...
const Navbar = ({ personalDetails, resume }) => {
  ...
  return (
    <nav className="navbar">
      ...
      <ul className="navbar__list">
        {["home", "about", "works", "skills", "timeline", "contact"].map(
          (link) => (
      ...
      <div className={`navbar__menu flexCenter ${menuToggle && "overlay"}`}>
        <motion.span variants={linksVariants} whileHover="menuBtnHover">
          <HiMenuAlt3
            className="navbar__menu__icon open flexCenter"
        ...
        <AnimatePresence>
          {menuToggle && (
            ...
            >
              <HiX
                className="navbar__menu__icon close flexCenter"
                ...
                <div className="navbar__menu__social__list">
                  {[
                    ...
                    <motion.a
                      ...
                      rel="noreferrer"
                      key={i}
                      className="navbar__menu__social__link"
                    >
